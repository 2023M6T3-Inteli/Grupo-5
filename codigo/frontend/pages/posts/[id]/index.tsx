...
export default function Index() {
    ...
    const [deletePostOpened, setDeletePostOpened] = useState(true); //trocar para false depois
    const deletePost = async () => {
    alert("This content has been successfully deleted.");
    };
      ...
      <Layout navbar={false} header={false} backgroundColor="#fff">
        <Container xs={12} md={6} lg={4}>
          ...
          <Row middle="xs" between="xs">
            <Col xs={2}>
              <ProfilePicture
                loader={() => "https://placehold.co/64x64"}
            ...
            <Col xs={10}>
              <Title variant="md" color="#000">
                {postDetails.user}
              </Title>

              <Text color="#000">{postDetails.role}</Text>
            </Col>
          </Row>
          ...
          <Row>
            <Col xs={12}>
              <Text color="#2e2e2e">{postDetails.content}</Text>
            </Col>
          </Row>
          ...
          <Row>
            <Col xs={12}>
              <img
                src={postDetails.imgURL || "https://placehold.co/350x300"}
                alt="Post"
                style={{
                  width: "100%",
                }}
          ...
          {postDetails.comments.length > 0 ? (
              ...
              <>
                <Row key={index} between="xs" middle="xs">
                  ...
                  <Col xs={10}>
                    ...
                    <Text color="#2e2e2eb7">{postDetails.role}</Text>
                  </Col>
                </Row>
                ...
                <Row center="xs">
                  <Col xs={12}>
                    <Text color="#2e2e2e">{comment}</Text>
                  </Col>
                </Row>
            ...
            <Row>
              <Col xs={12}>
                <Text color="#2e2e2e">No comments yet</Text>
              </Col>
            </Row>
          )}
        ...
        {deletePostOpened && (
          <DeleteConfirm
            ...
            submitText="Delete content"
            cancel={() => setDeletePostOpened(false)}
            submit={() => deletePost()}
          />
        )}
