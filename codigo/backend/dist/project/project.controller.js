...
let ProjectController = class ProjectController {
    ...
    update(id, updatePostDto) {
        this.projects = this.projects.map((post) => post.id === +id ? Object.assign(Object.assign({}, post), updatePostDto) : post);
        return this.projects.find((post) => post.id === +id);
    }
    remove(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_project_dto_1.UpdatePostDto]),
    __metadata("design:returntype", void 0)
