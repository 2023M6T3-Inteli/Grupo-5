...
hoistedDependencies:
  ...
  /@jest/core/29.5.0(ts-node@10.0.0):
    '@jest/core': private
  ...
  /jest-circus/29.5.0:
    jest-circus: private
  /jest-cli/29.5.0(@types/node@18.15.11)(ts-node@10.0.0):
    jest-cli: private
  /jest-config/29.5.0(@types/node@18.15.11)(ts-node@10.0.0):
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
  ...
  /tapable/2.2.1:
    tapable: private
  /terser-webpack-plugin/5.3.8(webpack@5.73.0):
...
pendingBuilds: []
prunedAt: Fri, 12 May 2023 13:24:38 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.2
storeDir: /home/marcelo/.local/share/pnpm/store/v3
